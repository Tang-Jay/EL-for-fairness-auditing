...
# ALL
# 输出
group_specific_data <- postive_caucasian_data
cat('\n-------------------------------\n')
cat(m,'ALL,')
...
m = 2
p_values <- rep(0,m)
sexs <- unique(postive_caucasian_data$sex)          
age_cats <- unique(postive_caucasian_data$age_cat)     
i = 0
